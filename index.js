...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nested function is able to access internal because of global binding
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
   let lowerCaseAnimals = array.map((element) => {
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopAnimals = array.filter((element) => {
  ...
  */
  ...
  function USApop(array){
   let totalAnimalPop = array.reduce((acc, population) => {
 ...
 console.log(consume('ryan', 'zillini', greeting))
